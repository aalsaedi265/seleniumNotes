...
class PythOrgSeach(unittest.TestCase):#test new page or functoin of website (test case)
    ...
    def setUp(self):#constructor for unittest, called per test case
        ...
        self.driver = webdriver.Chrome(r"C:\Users\16075\Documents\work\automationTesting\chromedriver.exe")
    ...
    def test_example(self):#start with test, INSURES unittest will run
        ...
        assert True
           #below code is used for search inpute look and confirm it is present
    ...
    #     mainPage.click_go_button() #click a button go to began search
    ...
    def test_direct_pageTransfer_pypl(self):
        mainPage = page.MainPage(self.driver)
        mainPage.goTo_pypl()
        print('-----click occured ------')
        checkIfPresent = page.noHover_direct_page_switch(self.driver)
        assert checkIfPresent.does_pypl_exist()
